...
//    })
    ...
    @Results({
        ...
        @Result(column="address", property="address", jdbcType=JdbcType.VARCHAR),
//        1：1
        @Result(column="id", property="account",one = @One(select = "com.example.byr.demo.mapper.AccountMapper.findAccountByUserId")),
//        1:N
        @Result(column="id", property="orderList", many = @Many(select = "com.example.byr.demo.mapper.UOrderMapper.findOrderListByUserId")),
    })
